...
//o Each lesson should also have a status property, which alternates between trueand false. This means "Lesson 1" will have
//status:"Lesson 2" will have status: false, and so on.
